...
class PackageModel {
  ...
  @override
  String toString() {
    return 'PackageModel{id: $id, responsibleUserId: $responsibleUserId, '
        'typeName: $typeName, status: $status, price: $price, '
        'description: $description, position: $position, sender: $sender, '
        'receiver: $receiver}';
  }
}
...
class PackagePositionModel {
  ...
  PackagePositionModel({required this.latitude, required this.longitude});

  factory PackagePositionModel.fromJson(Map<String, dynamic> json) =>
      _$PackagePositionModelFromJson(json);
...
class PackagePersonModel {
  ...
  factory PackagePersonModel.fromJson(Map<String, dynamic> json) =>
      _$PackagePersonModelFromJson(json);
