...
mixin _$PackageStore on _PackageStore, Store {
  ...
  @override
  int? get chosenPackageId {
    _$chosenPackageIdAtom.reportRead();
    return super.chosenPackageId;
  }

  @override
  set chosenPackageId(int? value) {
    _$chosenPackageIdAtom.reportWrite(value, super.chosenPackageId, () {
      super.chosenPackageId = value;
    });
  }
